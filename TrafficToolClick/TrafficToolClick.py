...
# helper panels
import InputPanelModuleClick # input panel
import VideoPanelModuleClick # video panel
...
class TrafficTool(Tk):
    def __init__(self, 
        ...
        self.title_label = tk.Label(master=self.title_frame, text="Traffic Tool Clicking v.1.0.3",)
...
#         self.right_label.pack()
        ...
        input_panel = InputPanelModuleClick.InputPanel(parent=self.left_frame, 
                                                  master=self, 
                                                  file_path=file_path, 
                                                  num_lanes=num_lanes, 
                                                  display_lanes=num_lanes,
                                                  debug=self.debug)
        video_panel = VideoPanelModuleClick.VideoPanel(parent=self.right_frame, 
                                                  master=self, 
                                                  file_path=file_path, 
                                                  view_name=view_name, 
...
#         input_panel.setResultPathFunc(video_panel.getResultFilePath)
        ...
        input_panel.setCanvas(video_panel.getCanvas())
...
#         # bind video_panel to input_panel for output func
        ...
        video_panel.setImgSizeFunc(input_panel.setImgSize)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-vfp", "--vfile_path", help = "view file path")
